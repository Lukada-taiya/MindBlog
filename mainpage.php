				  ...
				  <div class="container-fluid">
					 ...
					 <div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						  <li class="nav-item">
							 <a class="nav-link active" href="mainpage.php" aria-current="page" href="allposts.php">Home</a>
						  </li>
						  <li class="nav-item">
				...
				<div class="col-md-8">				
					...
					<div class="post card mb-5"> 
						...
						<div class="card-body">
							...
							<p class="card-text"><?php echo strlen($body) > 150 ? substr($body,0,150)."..." : $body; ?></p>
							<a class="btn btn-info read-btn" href="singlepost.php?id=<?php echo $id ?>"><span>Read More &rsaquo;&rsaquo;</span></a>							
						</div>
					</div>
